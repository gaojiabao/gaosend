...
#define VLAN2OFFSET (VLAN1OFFSET + VLANLEN)

/* Layer 3 */
#define ARPOFFSET(n)  (MACOFFSET + MACHDRLEN + n*VLANLEN)
#define IP4OFFSET(n)  (MACOFFSET + MACHDRLEN + n*VLANLEN)
#define IP6OFFSET(n)  (MACOFFSET + MACHDRLEN + n*VLANLEN)
